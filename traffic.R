...
get_googlemap("seoul", maptype="roadmap", zoom=11) %>%
  ...
  geom_point(data=location_200,aes(x=lon, y = lat), color='red')

#강북구
get_googlemap("gangbukgu", maptype="roadmap", zoom=13) %>%
  ggmap+geom_point(data=gangbuk, aes(x=lon,y=lat))+
  geom_point(data=location_200_1,aes(x=lon, y = lat), color='red')+
  geom_point(data=location_200_2,aes(x=lon, y = lat), color='red')+
  geom_point(data=location_200_3,aes(x=lon, y = lat), color='red')
